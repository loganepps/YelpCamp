...
function generateCampground(campground) {
    let template = `<div class="card mb-3">
            <div class="row">
                <div class="col-md-4">
                    <img class="img-fluid" alt="" src="${ campground.images.length ? campground.images[0].url : 'https://res.cloudinary.com/dw0rkoozx/image/upload/v1625151568/YelpCamp/vtjiotlo4qjjzhvmjqbu.jpg' }">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
